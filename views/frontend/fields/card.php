...
$cols           = isset($model['field']->options['items_per_row']) ? intval($model['field']->options['items_per_row']) : 1;
...
foreach ( $model['field']->options['choices'] as $option ) {
    ...
    ?>
    <div class="wapf-card <?php echo join( ' ', $class_atts['classes'] ) ?>" <?php echo Util::array_to_attributes( $wrapper_attributes ) ?> >
