...
$show_attachment_setting = ! empty( $model['show_attachment_setting'] );
?>
...
<div class="wapf-option-table" style="width: 100%;" rv-show="field.choices | isNotEmpty">
    <div class="wapf-options__header">
        ...
        <?php if( $show_attachment_setting ) { ?>
...
<div style="display: flex;align-items: center;justify-content: space-between">
    <div>
        <a href="#" rv-on-click="field.addChoiceEvent" class="button">
            <?php
                echo empty( $model['button_text'] ) ? __('Add option','sw-wapf' ) : esc_html( $model['button_text'] );
            ?>
        </a>
    </div>
    <div>
